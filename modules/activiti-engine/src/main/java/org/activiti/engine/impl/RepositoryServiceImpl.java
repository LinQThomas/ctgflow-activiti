...
public class RepositoryServiceImpl extends ServiceImpl implements RepositoryService {
  ...
  public Deployment deploy(DeploymentBuilderImpl deploymentBuilder, String companyId) {
    return commandExecutor.execute(new DeployCmd<Deployment>(deploymentBuilder, companyId));
  }


  public void deleteDeployment(String deploymentId) {
    commandExecutor.execute(new DeleteDeploymentCmd(deploymentId, false, RequestHolder.getId()));
  }
  public void deleteDeployment(String deploymentId, String companyId ) {
    commandExecutor.execute(new DeleteDeploymentCmd(deploymentId, false, companyId));
  }

  public void deleteDeploymentCascade(String deploymentId) {
    commandExecutor.execute(new DeleteDeploymentCmd(deploymentId, true, RequestHolder.getId()));
  }
  public void deleteDeploymentCascade(String deploymentId, String companyId) {
    commandExecutor.execute(new DeleteDeploymentCmd(deploymentId, true, companyId));
  }
  
  public void deleteDeployment(String deploymentId, boolean cascade) {
    commandExecutor.execute(new DeleteDeploymentCmd(deploymentId, cascade, RequestHolder.getId()));
  }

  public void deleteDeployment(String deploymentId, boolean cascade, String companyId) {
    commandExecutor.execute(new DeleteDeploymentCmd(deploymentId, cascade, companyId));
  }
  ...
  public Model newModel() {
    return commandExecutor.execute(new CreateModelCmd(RequestHolder.getId()));
  }
  ...
  public void addModelEditorSource(String modelId, byte[] bytes, String companyId) {
    commandExecutor.execute(new AddEditorSourceForModelCmd(modelId, bytes, companyId));
  }
  ...
  public Model getModel(String modelId, String companyId) {
    return commandExecutor.execute(new GetModelCmd(modelId,companyId));
  }
