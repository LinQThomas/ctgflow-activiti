...
public interface RepositoryService {
  ...
  void deleteDeployment(String deploymentId, String companyId);
   ...
   * @deprecated use {@link #deleteDeployment(String, boolean)}.  This methods may be deleted from 5.3.
   */
  void deleteDeploymentCascade(String deploymentId, String companyId);
   ...
   * @param deploymentId id of the deployment, cannot be null.
   */
  void deleteDeployment(String deploymentId, boolean cascade, String companyId);
  /**
  ...
  void addModelEditorSource(String modelId, byte[] bytes, String companyId);
  ...
  Model getModel(String modelId, String companyId);
  /**
