...
public class DeleteProcessInstanceCmd implements Command<Void>, Serializable {
  ...
  public DeleteProcessInstanceCmd(String processInstanceId, String deleteReason, String companyId) {
    this.processInstanceId = processInstanceId;
    this.deleteReason = deleteReason;
  ...
  public Void execute(CommandContext commandContext) { 
    ...
    if (companyId != null) {
      System.out.println("DeleteProcessInstanceCmd获取到租户=" + companyId);
